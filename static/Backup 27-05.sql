...
-- Tiempo de generación: 27-05-2024 a las 22:49:09
...
CREATE TABLE `dietas` (
  ...
  `tipoDieta` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `observacionesDieta` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
...
INSERT INTO `favoritos` (`idUsuarioFK`, `idProductoFK`, `idFavorito`) VALUES
(1, 1, 1),
(2, 9, 2),
(2, 3, 3),
(3, 215, 19);
...
(215, 'Cocaina', '100.00', '1.00', '1.00', '1.00', '1.00', '../media/prods/quanto-guadagna-ndrangheta-cocaina-744x445.jpg', 12);
...
--
ALTER TABLE `favoritos`
  MODIFY `idFavorito` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT de la tabla `productos`
--
ALTER TABLE `productos`
  MODIFY `idProducto` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=216;
